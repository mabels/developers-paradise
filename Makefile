...
manifest-latest:
	...
	$(MANIFEST_TOOL) push from-spec .build.manifest-latest.yaml
	...
	$(MANIFEST_TOOL) push from-spec .build.manifest-$(shell cat .rev).yaml
...
manifest-base:
	...
	$(MANIFEST_TOOL) push from-spec .build.manifest-base-latest.yaml
	...
	$(MANIFEST_TOOL) push from-spec .build.manifest-base-$(shell cat .rev).yaml
...
manifest-extend:
	...
	$(MANIFEST_TOOL) push from-spec .build.manifest-extend-latest.yaml
	...
	$(MANIFEST_TOOL) push from-spec .build.manifest-extend-$(shell cat .rev).yaml
...
manifest-ghrunner:
	...
	$(MANIFEST_TOOL) push from-spec .build.manifest-ghrunner-latest.yaml
	...
	$(MANIFEST_TOOL) push from-spec .build.manifest-ghrunner-$(shell cat .rev).yaml
...
manifest-ssm:
	...
	$(MANIFEST_TOOL) push from-spec .build.manifest-ssm-latest.yaml
	...
	$(MANIFEST_TOOL) push from-spec .build.manifest-ssm-$(shell cat .rev).yaml
...
manifest-codeserver:
	...
	$(MANIFEST_TOOL) push from-spec .build.manifest-codeserver-latest.yaml
	...
	$(MANIFEST_TOOL) push from-spec .build.manifest-codeserver-$(shell cat .rev).yaml
...
manifest-codeserver-swift:
	...
	$(MANIFEST_TOOL) push from-spec .build.manifest-codeserver-swift-latest.yaml
	...
	$(MANIFEST_TOOL) push from-spec .build.manifest-codeserver-swift-$(shell cat .rev).yaml
...
manifest-ghrunner-swift:
	...
	$(MANIFEST_TOOL) push from-spec .build.manifest-ghrunner-swift-latest.yaml
	...
	$(MANIFEST_TOOL) push from-spec .build.manifest-ghrunner-swift-$(shell cat .rev).yaml
...
.built.$(ARCH).Dockerfile.base: .build.$(ARCH).Dockerfile.base.$(ARCH) Dockertempl.base-setup Dockertempl.base Dockertempl.base
	...
	$(DOCKER) buildx build $(DOCKER_BUILD_ARGS) -t developers-paradise:base-$(ARCH)-$(shell cat .rev) -f .build.$(ARCH).Dockerfile.base.versioned .
...
.built.$(ARCH).Dockerfile.ghrunner-swift:
	...
	$(DOCKER) buildx build $(DOCKER_BUILD_ARGS) -t developers-paradise:ghrunner-swift-$(ARCH)-$(shell cat .rev) -f .build.$(ARCH).Dockerfile.ghrunner-swift.versioned .
...
.built.$(ARCH).Dockerfile.codeserver-swift:
	...
	$(DOCKER) buildx build -t developers-paradise:codeserver-swift-$(ARCH)-$(shell cat .rev) -f .build.$(ARCH).Dockerfile.codeserver-swift.versioned .
...
.built.$(ARCH).Dockerfile.ghrunner:
	...
	$(DOCKER) buildx build $(DOCKER_BUILD_ARGS) -t developers-paradise:ghrunner-$(ARCH)-$(shell cat .rev) -f .build.$(ARCH).Dockerfile.ghrunner.versioned .
...
.built.$(ARCH).Dockerfile.ssm: startup-ssm.sh
	...
	$(DOCKER) buildx build $(DOCKER_BUILD_ARGS) -t developers-paradise:ssm-$(ARCH)-$(shell cat .rev) -f .build.$(ARCH).Dockerfile.ssm.versioned .
...
.built.$(ARCH).Dockerfile.codeserver:
	...
	$(DOCKER) buildx build $(DOCKER_BUILD_ARGS) -t developers-paradise:codeserver-$(ARCH)-$(shell cat .rev) -f .build.$(ARCH).Dockerfile.codeserver.versioned .
